            ...
            >
                ...
                <motion.div className={styles.headerSection} variants={cardVariants}>
                    ...
                    <h2 className={styles.mainTitle}>
                        Proyectos que cobran{' '}
                        <span className={styles.titleGradient}>vida digital</span>
                    </h2>
                    <p className={styles.description}>
                        Una selección de proyectos que reflejan mi pasión por crear soluciones web innovadoras, 
                        ...
                        >
                            ...
                            <div className={styles.cardContent}>
                                ...
                                <div className={styles.techStack}>
                                    ...
                                    {project.icons && project.icons.length > 4 && (
