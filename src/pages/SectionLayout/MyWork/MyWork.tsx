            ...
            >
                ...
                <motion.div className={styles.headerSection} variants={itemVariants}>
                    <div className={styles.badge}>
                        ...
                        <span>{translations.work.title.toUpperCase()}</span>
                    </div>
                ...
                <motion.div className={styles.featuredSection} variants={itemVariants}>
                    <div className={styles.featuredLabel}>
                        ...
                        <span>{translations.work.featured}</span>
                    </div>
                        ...
                        <div className={styles.featuredContent}>
                            <div className={styles.featuredHeader}>
                                ...
                                {featuredProject.status && (
                                    <span className={styles.statusBadge}>{language === 'es' ? featuredProject.status : featuredProject.statusEn}</span>
                                )}
                            </div>
                            
                            <p className={styles.featuredDescription}>{language === 'es' ? featuredProject.text : featuredProject.textEn}</p>
                            ...
                            <div className={styles.projectActions}>
                                {featuredProject.page && (
                                    ...
                                    >
                                        ...
                                        <span>{translations.work.cta.viewProject}</span>
                                    </motion.a>
                                )}
                                {featuredProject.github && (
                                    ...
                                    >
                                        ...
                                        <span>{translations.work.cta.viewCode}</span>
                                    </motion.a>
                                )}
                            </div>
                        </div>
                ...
                <motion.div className={styles.projectsSection} variants={itemVariants}>
                    <h3 className={styles.sectionTitle}>{translations.projects.title}</h3>
                            ...
                            >
                                ...
                                <div className={styles.cardContent}>
                                    <div className={styles.cardHeader}>
                                        ...
                                        {project.status && (
                                            <span className={styles.cardStatus}>{language === 'es' ? project.status : project.statusEn}</span>
                                        )}
                                    </div>
                                    <p className={styles.cardDescription}>{language === 'es' ? project.text : project.textEn}</p>
