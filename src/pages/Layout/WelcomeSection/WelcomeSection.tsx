            ...
            <div className={styles.content}>
                ...
                <div>
                    <div className={styles.textProfile}>
                        <h1 className={styles.name}>Lautaro Nahuel García</h1>
                        ...
                        <div className={styles.buttons}>
                            ...
                            <button className={styles.button} onClick={copyText}>
                                <svg className={styles.icon} xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 32 32"><path fill="none" stroke="#0284c7" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M29 9v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V9m26 0a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2m26 0l-11.862 8.212a2 2 0 0 1-2.276 0L3 9" /></svg>
                                Email
                            </button>
                            <Toaster />
                        </div>
